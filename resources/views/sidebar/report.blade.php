        ...
        <div class="collapse navbar-collapse ">
            <ul class="flex-md-column flex-row navbar-nav w-100 justify-content-between">
                ...
                <li class="nav-item active">
                    <a class="nav-link pl-0" href="{{ route('form/report') }}"><i class="fa fa-cog fa-fw"></i> <span class="d-none d-md-inline">Les factures</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link pl-0" href="{{ route('form/users') }}"><i class="fa fa-heart codeply fa-fw"></i> <span class="d-none d-md-inline">Maintenance</span></a>
                </li>

                <li class="nav-item">
                    <a class="nav-link pl-0" href="{{ route('/daterange') }}"><i class="fa fa-heart codeply fa-fw"></i> <span class="d-none d-md-inline">student</span></a>
                </li>
